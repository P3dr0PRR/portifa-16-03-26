  ...
  return (
    <section className="flex flex-col justify-start gap-4 px-6 py-12 md:px-16 md:py-20">
      ...
      <div className="w-full flex flex-col items-center gap-6 bg-gray-800 border border-gray-600 p-6 md:p-8 rounded-md">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-3 border border-gray-500 rounded-md bg-gray-500/40 p-4">
          <p className="font-bold font-['Syne'] text-indigo-400 text-center max-w-xl leading-tight">
            Meios
          </p>
          {MEIOS.map((MEIOS: Ctt) => (
            <div
